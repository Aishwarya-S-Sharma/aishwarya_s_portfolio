...
const Projects = () => {
  return (
    ...
    <ProjectCard title="Netflix Clone" main="Netflix landing page clone using html and  css" image={netflix} demoLink="https://aishwarya-s-sharma.github.io/Netflix-Clone/" sourceLink="https://github.com/Aishwarya-S-Sharma/Netflix-Clone.git"/>
